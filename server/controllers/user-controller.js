...
module.exports.controller = app => {
  ...
  router.post('/user-login', (req, res) => {
    ...
    user.User.findByCredentials(body.password, body.username)
      .then(user => {
  ...
  router.post('/admin-login', (req, res) => {
    ...
    user.Admin.findByCredentials(body.password, 0, body.admin_id)
      .then(user => {
  ...
  router.post('/forgot-password', (req, res) => {
    ...
    userType
      .createResetPasswordToken(req.body.email)
      .then(() => {
        res.status(200).send()
      })
      .catch(e => {
